---
title: The Birth of a Raycast Extension
date: 2022-08-02
tags:
  - Raycast
categories:
...
The whole thing started after replying to one of DIYgod's tweets...
...
After much procrastination, it's finally finished. It can be integrated with most documentation websites that support DocSearch.

![DocSearch Raycast's extension interface](/images/AbPWJgKTtSl8aR1.png)

Currently, it supports most front-end documentation websites.
Welcome to use it, and feel free to submit more documentation websites 🙏.
